...
function Lightbox({ items, index, onClose }: {
  ...
  return (
    ...
    >
      ...
      {/* Image */}
      <div className="px-20 md:px-32 max-h-[85vh] flex flex-col items-center gap-4" onClick={e => e.stopPropagation()}>
        <img
          src={items[current].src}
          alt={items[current].alt}
          className="max-h-[78vh] max-w-full object-contain"
        />
        <p className="font-sans text-xs text-white/50 uppercase tracking-widest text-center">
          {items[current].alt}
        </p>
      </div>
          ...
          <div className="columns-2 lg:columns-3 xl:columns-4 gap-3 space-y-3">
            {filtered.map((item, i) => (
              ...
              >
                ...
                />
                {/* Hover overlay */}
                <div className="absolute inset-0 bg-enterprise-black/0 group-hover:bg-enterprise-black/50 transition-all duration-300 flex items-end">
